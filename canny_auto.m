...
%       - particle_tracking_results.mat : All particle positions and metadata
...
function canny_auto(fileParams, caParams)
    fprintf("\n")
    ...
    %if exist('DISPLAY_FIGURES', 'var') && DISPLAY_FIGURES
        ...
        %    subplot(rows, cols, (row*cols) + col + 1);
       %     imshow(all_images{i});
    ...
    img1 = 'testdata/images/piece_0_0.png'; % First image (R0,C0)
    img2 = 'testdata/images/piece_0_1.png'; % Second image (R0,C1)
    img3 = 'testdata/images/piece_1_0.png'; % Third image (R1,C0)
    ...
    if exist('DISPLAY_FIGURES', 'var') && caParams.displayFigures
